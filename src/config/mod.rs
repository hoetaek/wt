...
pub use schema::{
    ...
    DepCommand, EditorConfig, EditorPlacement, IssueProviderType, IssuesConfig, ProfileConfig,
    RESERVED_PROFILE_NAME, ReadyMode, ReviewCodexBasePolicy, ReviewConfig, ReviewDefaultPolicy,
    SetupConfig, SiteConfig, SiteProvider, SubmitMode, WORKSPACE_COLOR_KIND_BRANCH,
    WORKSPACE_COLOR_KIND_ISSUE, WORKSPACE_COLOR_KIND_PR, WORKSPACE_COLOR_KIND_TASK,

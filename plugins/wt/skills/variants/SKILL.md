...
`../autopilot/references/task-lifecycle.md`. Variants are represented as:
...
| Phase | Where |
|---|---|
| problem still vague | `ready` idea capture |
| prepare variants + matrix workflow | this skill |
| launch, monitor, PR review, bot feedback, complete | `work` |
| land selected branch | `land` |
...
Launch with `work` or the explicit command:

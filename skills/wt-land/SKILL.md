...
workflow's spec or `03-Architect/09-execution.md` so future readers understand the history.
...
- Prefer `<repo-root>/.wt/planning/specs/<slug>/04-Feedback/11-retrospect.md` for
  spec-backed work.

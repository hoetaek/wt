...
const STRINGS = {
  en: {
    ...
    noteTaskRuns: "TaskRuns are execution records from <git-common-dir>/wt/execution/task-runs with linked TaskDocument content. Failed or broken links are grouped under Needs attention.",
    noteProfiles: "Profiles are effective agent/config overlays from <git-common-dir>/wt/config/profiles.",
  ...
  ko: {
    ...
    noteTaskRuns: "작업 실행은 <git-common-dir>/wt/execution/task-runs 실행 기록입니다. 실패했거나 연결이 깨진 항목은 확인 필요로 묶습니다.",
    noteProfiles: "프로필은 <git-common-dir>/wt/config/profiles의 agent/config overlay입니다.",

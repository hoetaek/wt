---
name: wt-ready
description: "Use before wt-work to verify prepared context is executable as wt development work, slice it, author TaskDocument bodies via wt-writing-tasks, choose execution shape and workflow policy, and hand off an exact launch target. For vague work that still needs thinking, route to leaf-work and stop."
---
...
workspace). wt-ready starts when context might already be executable and ends
with either an exact `wt-work` launch target or an explicit routing decision
back to thinking.
...
| launch, watch, steer, accept | `wt-work` |
| landing, cleanup, retrospective | `wt-land` |
...
**REQUIRED SUB-SKILL:** Use wt-writing-tasks for every TaskDocument body. It
...
- existing TaskDocuments/workflow verified ready, with the exact `wt-work`
  target

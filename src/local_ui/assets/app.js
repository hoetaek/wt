...
const STRINGS = {
  en: {
    ...
    noteRetrospecs: "Retrospecs are legacy repo-root completed-work reflections included for read-only context.",
  ...
  ko: {
    ...
    noteRetrospecs: "회고는 읽기 전용 맥락으로 보여주는 legacy repo-root 완료 작업 기록입니다.",

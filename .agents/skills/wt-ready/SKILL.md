...
- Security: write 는 `<git-common-dir>/wt/execution/tasks/*.toml` 만.
...
Background reason: empirically (`<git-common-dir>/wt/planning/specs/wt-studio-authoring-surface/11-retrospect.md`)

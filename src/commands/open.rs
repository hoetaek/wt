...
mod tests {
    ...
    fn open_starts_post_deps_tabs_and_opens_workspace_url() {
        ...
        assert_eq!(
            command_arg,
            "unset WT_COORDINATOR_AGENT_ID; export WT_AGENT_ID=agents/feature; codex --model repo-feature --cd /tmp/repo-feature"
        );
...
"#,
        ...
        assert_eq!(
            command_arg,
            "unset WT_COORDINATOR_AGENT_ID; export WT_AGENT_ID=agents/feature-codex; codex --model gpt-5.5"
        );
    }
...
"#,
        ...
        assert_eq!(
            command_arg,
            "unset WT_COORDINATOR_AGENT_ID; export WT_AGENT_ID=agents/feature-codex-yolo; codex --yolo"
        );
    }
    ...
    fn open_falls_back_to_root_config_when_profile_file_is_missing() {
        ...
        assert_eq!(
            command_arg,
            "unset WT_COORDINATOR_AGENT_ID; export WT_AGENT_ID=agents/feature-codex; claude"
        );
    }
